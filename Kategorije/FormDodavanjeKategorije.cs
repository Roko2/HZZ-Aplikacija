...
namespace HZZ_Kategorije
{
    public partial class FormDodavanjeKategorije : Form
    {
        ...
        private void buttonDodaj_Click(object sender, EventArgs e)
        {
            ...
            kategorijeDB = _categoryRepository.GetDBCategories();
            ...
            {
                kategorije = _categoryRepository.GetCategories();
                ...
                DataGridView tablica = (DataGridView)this.oKategorija.Controls[1].Controls[1].Controls[14];

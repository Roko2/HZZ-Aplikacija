...
namespace HZZ_Kategorije
{
    public partial class FormDodavanjePosla : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            lRadnaMjesta = _jobRepository.GetDBFreeJobs();
            var postoji = (from x in lRadnaMjesta where Convert.ToInt32(odabranaRadnaMjesta.IdPosao) == x.IdPosao select x).Any();
            if (postoji == true) {
            ...
            else
            {
                ...
                DataGridView tablica = (DataGridView)this.oPosao.Controls[0].Controls[1].Controls[0];
